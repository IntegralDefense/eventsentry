        ...
        if force or self.has_critical_file_changed(files):
            ...
            for md5 in screenshot_dict:
                ...
                try:
                    ...
                    self.logger.debug('Symlinked to ACE screenshot: {}'.format(screenshot_dict[md5]))
                    ...
                    if f['path'] == email['path']:
                        ...
                        for screenshot in email['screenshots']:
                            ...
                            try:
                                ...
                                self.logger.debug('Symlinked to email screenshot: {}'.format(screenshot))
                            except FileExistsError:
                                pass
    ...
    def package_event(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with tempfile.TemporaryDirectory() as temp_malware_dir:
                ...
                malware_zip_password = config['package']['malware_zip_password']
            ...
            intel_zip_password = config['package']['intel_zip_password']
